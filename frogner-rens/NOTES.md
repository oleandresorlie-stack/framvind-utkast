...
- Socials (live only): Facebook https://www.facebook.com/Frogner-Rens-og-Vask-As-115966418592633/ — Instagram not found (not invented)
- Google: no public stars/count on live or open Maps — omitted invented numbers; Maps search link only
- Hours: not published on live — Night Rescue / kontakt say ring to confirm
...
- Mirror: `/workspace/previews/frogner-rens/`
- Package: `/workspace/previews/_packages/frogner-rens.tar.gz`
- Intended URL (CoS deploy only): https://utkast.framvind.no/frogner-rens/
- Mac target (not synced from this box Shell — no machineId): `/Users/oleandre/Documents/Framvind AS/previews/frogner-rens/` · machineId `765ad993-51de-4b9f-a555-ca0780fd2591`
